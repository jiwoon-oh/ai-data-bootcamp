...
# 결론
  - Promotion2를 사용하였을때 가장 평균 매출이 낮은 결과가 나왔고 이는 통계적으로 유의하다는것을 볼 수 있었다.
...
=============================매출 손실=============================
  - promotion 2를 진행한 매장 47개의 손실 요약
  1. vs promotion 1
...
=============================결론=============================
  - Promotion 2는 보류를 제안한다. 통계적 유의성, 효과 크기, 교란변수 부재, 세그먼트 전반의 일관성, 이상치에 대한 강건성까지 모든 검증을 통과했으며 실질적인 매출 손실 규모도 무시할 수 없는 수준이다.
